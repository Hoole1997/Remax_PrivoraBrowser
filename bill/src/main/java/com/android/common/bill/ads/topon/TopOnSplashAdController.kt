...
class TopOnSplashAdController private constructor() {
                ...
                splashAd = TUSplashAd(
                    ...
                    object : TUSplashAdEZListener() {
                        ...
                        override fun onAdClick(adInfo: TUAdInfo) {
                            ...
                            AdEventReporter.reportClick(AdType.APP_OPEN, AdPlatform.TOPON, placementId, currentAdUniqueId, totalClickCount, adInfo.networkName ?: "", adInfo.publisherRevenue ?: 0.0, "USD", sessionId = currentSessionId)
                        }
                        ...
                        override fun onAdDismiss(adInfo: TUAdInfo, splashAdExtraInfo: TUSplashAdExtraInfo) {
                            ...
                            totalCloseCount++
                            AdEventReporter.reportClose(AdType.APP_OPEN, AdPlatform.TOPON, placementId, totalCloseCount, adInfo.networkName ?: "", adInfo.publisherRevenue ?: adInfo.ecpm ?: 0.0, adInfo.currency ?: "USD", sessionId = currentSessionId)
    ...
    fun getCachedAdPeek(placementId: String? = null): TUSplashAd? {
        val finalPlacementId = placementId ?: BillConfig.topon.splashId
