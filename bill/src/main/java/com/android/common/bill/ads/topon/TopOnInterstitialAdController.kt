...
class TopOnInterstitialAdController private constructor() {
    ...
    fun getCachedAdPeek(placementId: String? = null): com.thinkup.interstitial.api.TUInterstitial? {
        return getCurrentAd(placementId)
    }
    ...
    private inner class TopOnInterstitialListener(
        ...
        override fun onInterstitialAdClicked(adInfo: TUAdInfo) {
            ...
            AdEventReporter.reportClick(AdType.INTERSTITIAL, AdPlatform.TOPON, placementId, currentAdUniqueId, totalClickCount, adInfo.networkName ?: "", adInfo.publisherRevenue ?: 0.0, adInfo.currency ?: "", sessionId = currentSessionId)
        }
        ...
        override fun onInterstitialAdClose(adInfo: TUAdInfo) {
            ...
            AdEventReporter.reportClose(AdType.INTERSTITIAL, AdPlatform.TOPON, placementId, totalCloseCount, adInfo.networkName ?: "", adInfo.publisherRevenue ?: 0.0, adInfo.currency ?: "", sessionId = currentSessionId)
            ...
            // 插页关闭时重新预缓存
            val reloadSessionId = currentSessionId
