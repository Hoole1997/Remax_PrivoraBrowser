        ...
        return suspendCancellableCoroutine { continuation ->
            ...
            appOpenAd.adEventCallback = object : AppOpenAdEventCallback {
                ...
                override fun onAdPaid(value: AdValue) {
                    ...
                    // 上报真实的广告收益数据
                    AdRevenueReporter.reportRevenue(AdType.APP_OPEN, AdPlatform.ADMOB, adUnitId, value.valueMicros / 1_000_000.0, value.currencyCode, appOpenAd.getResponseInfo().loadedAdSourceResponseInfo?.name ?: "Admob", appOpenAd.getResponseInfo().loadedAdSourceResponseInfo?.instanceName.orEmpty())
                }
