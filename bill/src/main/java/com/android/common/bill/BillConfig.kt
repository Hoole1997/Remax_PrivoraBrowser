...
object BillConfig {
    ...
    // ==================== 广告平台配置 ====================
    var googleMobileAds: GoogleMobileAdsConfig = GoogleMobileAdsConfig()
    var admob: AdmobConfig = AdmobConfig()
    var gam: GamConfig = GamConfig()
    ...
    var gamNativeRenderer: GamNativeAdRenderer? = null
    var gamFullScreenNativeRenderer: GamFullScreenNativeAdRenderer? = null
    ...
    // ==================== Google Mobile Ads 通用配置 ====================
    data class GoogleMobileAdsConfig(
