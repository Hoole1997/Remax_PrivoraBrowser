...
return try {
    ...
    fun getCachedAdPeek(placementId: String? = null): com.thinkup.rewardvideo.api.TURewardVideoAd? {
    ...
    private inner class TopOnRewardedVideoListener(
        ...
        override fun onRewardedVideoAdPlayClicked(adInfo: TUAdInfo) {
            ...
            AdEventReporter.reportClick(AdType.REWARDED, AdPlatform.TOPON, placementId, currentAdUniqueId, totalClickCount, adInfo.networkName ?: "", adInfo.publisherRevenue ?: 0.0, adInfo.currency ?: "", sessionId = currentSessionId)
        }
        ...
        override fun onReward(adInfo: TUAdInfo) {
            ...
            AdEventReporter.reportRewardEarned(AdType.REWARDED, AdPlatform.TOPON, placementId, totalRewardEarnedCount, adInfo.networkName ?: "", rewardType, rewardAmount, sessionId = currentSessionId)
