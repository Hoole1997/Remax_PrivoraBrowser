...
class PangleFullScreenNativeAdController private constructor() {
    ...
    fun closeEvent(
        ...
        totalCloseCount++
        AdEventReporter.reportClose(AdType.FULL_SCREEN_NATIVE, AdPlatform.PANGLE, adUnitId, totalCloseCount, adSource ?: AdPlatform.PANGLE.key, valueUsd ?: 0.0, currencyCode ?: "USD", sessionId = currentSessionId)
    }
                    ...
                    val bindSuccess = nativeAdView.bindFullScreenNativeAdToContainer(
                        ...
                        interactionListener = object : PAGNativeAdInteractionCallback() {
                            ...
                            override fun onAdClicked() {
                                ...
                                AdEventReporter.reportClick(AdType.FULL_SCREEN_NATIVE, AdPlatform.PANGLE, finalAdUnitId, currentAdUniqueId, totalClickCount, currentAdSource ?: AdPlatform.PANGLE.key, nativeAd.pagRevenueInfo?.showEcpm?.revenue?.toDoubleOrNull() ?: 0.0, currentCurrency ?: "USD", sessionId = currentSessionId)
                            }
