...
class PangleRewardedAdController private constructor() {
    ...
    fun getCachedAdPeek(adUnitId: String? = null): PAGRewardedAd? {
        ...
        return suspendCancellableCoroutine { continuation ->
            ...
            rewardedAd.setAdInteractionCallback(object : PAGRewardedAdInteractionCallback() {
                ...
                override fun onAdClicked() {
                    ...
                    AdEventReporter.reportClick(AdType.REWARDED, AdPlatform.PANGLE, adUnitId, currentAdUniqueId, totalClickCount, currentAdSource ?: AdPlatform.PANGLE.key, rewardedAd.pagRevenueInfo?.showEcpm?.revenue?.toDoubleOrNull() ?: 0.0, currentCurrency ?: "USD", sessionId = sessionId)
                }
                ...
                override fun onUserEarnedReward(rewardItem: PAGRewardItem) {
                    ...
                    hasRewarded = true
                    AdEventReporter.reportRewardEarned(AdType.REWARDED, AdPlatform.PANGLE, adUnitId, totalRewardEarnedCount, currentAdSource ?: AdPlatform.PANGLE.key, rewardItem.rewardName, rewardItem.rewardAmount, sessionId = sessionId)
