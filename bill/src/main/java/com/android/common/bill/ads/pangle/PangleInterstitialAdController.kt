...
class PangleInterstitialAdController private constructor() {
        ...
        return suspendCancellableCoroutine { continuation ->
            ...
            interstitialAd.setAdInteractionListener(object : PAGInterstitialAdInteractionCallback() {
                ...
                override fun onAdClicked() {
                    ...
                    AdEventReporter.reportClick(AdType.INTERSTITIAL, AdPlatform.PANGLE, adUnitId, currentAdUniqueId, totalClickCount, currentAdSource ?: AdPlatform.PANGLE.key, revenueValue, currentCurrency ?: "USD", sessionId = sessionId)
                }
                ...
                override fun onAdDismissed() {
                    ...
                    AdEventReporter.reportClose(AdType.INTERSTITIAL, AdPlatform.PANGLE, adUnitId, totalCloseCount, currentAdSource ?: AdPlatform.PANGLE.key, revenueValue, currentCurrency ?: "USD", sessionId = sessionId)
    ...
    fun getCachedAdPeek(adUnitId: String? = null): PAGInterstitialAd? {
    ...
    fun getCurrentAd(adUnitId: String? = null): PAGInterstitialAd? = getCachedAdPeek(adUnitId)
